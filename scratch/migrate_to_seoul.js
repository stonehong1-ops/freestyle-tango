...
// [SOURCE] - Existing US Project (tangostay-7355e)
// Manually reconstructing to avoid JSON parse errors from shell
const sourceSa = {
...
// [TARGET] - New Seoul Project (freestyle-tango-seoul)
const targetSa = {
  type: "service_account",
...
async function migrate() {
  console.log('🚀 Starting Migration: US -> SEOUL');
  ...
  for (const collectionName of collections) {
    ...
    try {
      ...
      console.log(`  - Error accessing ${collectionName}, skipping.`);
      continue;
    }
    ...
    // Use batches for performance and to stay within limits
    ...
    await batch.commit();
    console.log(`  ✅ Done! Migrated ${count} docs from ${collectionName}.`);
  }

  console.log('\n✨ All Firestore data migrated successfully.');
}

...
async function test() {
  const buckets = ['freestyle-tango-seoul.firebasestorage.app', 'freestyle-tango-seoul.appspot.com', 'freestyle-tango-seoul'];
  for (const b of buckets) {
      try {
          ...
          const [exists] = await app.storage().bucket().exists();

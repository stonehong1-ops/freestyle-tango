export default {
  ...
  milonga: {
    title: 'Prenotazione Milonga',
    reserveBtn: 'Prenota',
    status: 'Stato',
  },
  class: {
    title: 'Richiesta Classe',
    applyBtn: 'Richiedi',
    applied: 'Richiesto',
  },
  mypage: {
    title: 'La mia pagina',
    registrations: 'Dettagli Richiesta',
  ...
  common: {
    ...
    hostGuide: {
      ...
      list: [
        { t: '🔓 Check-in / Out (Flessibile)', d: 'Ingresso contactless. Password e info camera inviati tramite messaggio il giorno del check-in.\nStandard: Check-in 15:00 / Check-out 11:00 (Può essere regolato per tua comodità!)' },
        { t: '🏠 Regole rigorose', d: 'Assoluto DIVIETO DI FUMO in tutto l\'edificio. Si applicano spese di pulizia speciali in caso di violazione.\nPer favore, differenzia il riciclaggio e lava i piatti prima del check-out.\nEssendo uno studio di nuova costruzione, astieniti dai rumori forti dopo le 22:00.' },
        { t: '🤩 Comunicazione host 24/7', d: 'Contattami in qualsiasi momento, anche la mattina presto! Non esitare a scrivermi se sei a disagio.\nSe ti mancano articoli essenziali durante il soggiorno, fammelo sapere. Li acquisterò e consegnerò in giornata.' }
      ]
    },
    contact: {
      title: 'Contattaci',
  ...
  stays: {
    hapjeong: {
      ...
      gallery: {
        ...
        categories: ['Tutto', 'Soggiorno', 'Camera da letto', 'Cucina', 'Bagno', 'Vista'],
        descriptions: [
      ...
      calendar: {
        ...
        priceInfo: 'Check-in intelligente / Base 2 ospiti (Max 3)',
        basePrice: 'Settimanale: 90,000 KRW / Fine settimana: 120,000 KRW',
        feeGuideLines: [
      ...
      guide: {
        ...
        highlights: {
          ...
          list: [
            { t: 'Nuova costruzione premium con vista aperta', d: 'Goditi eccezionali viste sul fiume Han dallo studio più nuovo e pulito nell\'area di Hapjeong/Hongdae.' },
            { t: 'Pulizia senza compromessi', d: 'La biancheria e i tappeti vengono lavati professionalmente da Laundrygo ogni volta. Pulizia a vapore degli interni e tutti gli asciugamani/strofinacci vengono sostituiti al 100% con nuovi.' },
            { t: 'Mobili per il relax premium', d: 'Due letti spaziosi (Queen, Super Single), divano accogliente e una poltrona massaggiante reclinabile ad alte prestazioni.' },
            { t: 'Intrattenimento ricco', d: 'Soggiorno con Samsung Moving Style Smart TV 2026, oltre a una TV aggiuntiva in camera da letto.' }
          ],
        ...
        transport: {
          ...
          list: [
            { t: 'Posizione super privilegiata', d: '1 min a pie dalla stazione di Hapjeong. Accesso rapido a Hongdae/Sinchon a piedi/metro/autobus (10 min a piedi da Hongdae).' },
            { t: 'Hub di trasporto', d: 'Punto di convergenza per tutti gli autobus che si spostano per Seul. (Stazione Mangwon, Stazione Hongdae tutte adiacenti)' },
            { t: 'Parcheggio conveniente', d: 'Porta la tua auto e parcheggia gratuitamente. (L\'host copre la tariffa mensile di 30,000 KRW)' },
            { t: 'Guida e taxi', d: 'Solo 1 minuto per immettersi nella superstrada Gangbyeon verso Gangnam, Ilsan, Yeouido.' }
          ]
        },
        facilities: {
        ...
        attractions: {
          ...
          list: [
            { t: 'Distretto di Hapjeong / Hongdae', d: 'Adiacente ai migliori ristoranti e caffè di Hapjeong e alle vivaci strade di Hongdae.' },
            { t: 'Supermercati convenienti', d: 'Wang Mart è a 1 min per la spesa rapida. Homeplus Mega Mart è a 5 min a piedi per tutto il resto.' },
            { t: 'Fuga sul fiume Han in qualsiasi momento', d: '1 minuto a piedi dall\'ingresso del parco Hangang. Strettamente collegato al parco Mangwon Hangang.' }
          ]
        }
      }
    },
  ...
  // Elementi comuni (per compatibilità)
  calendar: {
    checkin: 'Check-in',
    checkout: 'Check-out',
    ...
    surcharge: 'Include supplemento weekend/festivi',
    ...
    guestOptions: ['1 Ospite (Base)', '2 Ospiti (+10k/notte)', '3 Ospiti (+20k/notte)', '4 Ospiti (Max, +30k/notte)'],
    ...
    stay: 'Soggiorno',
    selectedDate: 'Date selezionate',
    viewList: 'Vedi come lista',
    viewCalendar: 'Vedi come calendario'
  },
  location: {
  ...
  complete: {
    ...
    hostSmsBtn: 'Notifica l\'host (SMS)',
    guideBtn: 'Anteprima guida all\'uso',
    homeBtn: 'Torna alla Home',
    sms: '[{stayName} Conferma prenotazione]\nOspite: {name}\nDate: {checkIn} ~ {checkOut}\nPersone: {guests}\nImporto: {total} KRW\n\n[Info Check-in]\nOra: 16:00\nPassword: 9999\n\nGrazie!'
  }
};
